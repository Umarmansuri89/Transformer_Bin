...
class ColorValues {
  ...
  static const Color red_color = Color(0xffFF4D4D);
  static const Color grey_color = Color(0xff1C1B1F);
  static const Color greyy_color = Color(0xffB8B7B6);
  static const Color button_info_text_color = Color(0xffFFFFFF);
  static const Color dashbboard_card_back_color = Color(0xffFFEDDC);
  static const Color dashbboard_card_back_colorr = Color(0xff3987CF);
  static const Color dashbboard_card_back_colorrr = Color(0xff6DC965);
  static const Color dashbboard_card_back_colorrrr = Color(0xff63CFDE);

  static const Color Sched_backgroung_COLOR = const Color(0xFFFFF8F1);
  static const Color text_coller = const Color(0xFF2E2E2E);
  static const Color green_background = const Color(0xFF6DC965);
  static const Color lightblue_background = const Color(0xFF63CFDE);
  static const Color blue_background = const Color(0xFF3987CF);
  static const Color rv_hookup_coller = const Color(0xFF1C1B1F);
  ...
  static const Color SIGIN_TITLE_COLOR = Color(0xFFb3be85);
  static const Color YELLOW = Color(0xFFFEBD0B);
  static const Color SLIDER_BACKGROUND_COLOR = Color(0xFFF2F2F2);
  static const Color NOTIFICATION_BLUE = Color(0xFF004AD7);
  static const Color BG_TYPE = Color(0xFF2d2d2d);
  static const Color BLACK = Color(0xFF000000);
  static const Color BG_BT2 = Color(0xFFff2f2f);
  static const Color LOGOUT_TEXT = Color(0xFFF9016B);
  static const Color BG_ORDER = Color(0xFFB4bd84);
  static const Color BUTTON_COLOR = Color(0xFF71af3e);
  static const Color DIVIDER_COLOR = Color(0xFFBBBBBB);
  static const Color PAYMENT_OPTION_BACK = Color(0xFFF8F7FA);
  static const Color TIME_NOTITFICAITON = Color(0xFF949494);
  static const Color TEXT_COLOR = Color(0xFF080255);
  static const Color CALL_COLOR = Color(0xFF23D61F);
  static const Color HINT_TEXT_COLOR = Color(0xFF3F3D56);
  static const Color BACKGROUND = Color(0xff00F9FF);
  static const Color TEXT_SENT_OTP_COLOR = Color(0xFF6D6d6D);
  static const Color GREY_BORDER_COLOR = Color(0xFFD0DBDF);
